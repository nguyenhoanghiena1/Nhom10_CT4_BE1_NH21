...
class Products extends Db {
    ...
    public function getSellingProducts() { //lay ra 10 san pham moi nhat
    ...
    public function getProductsByID($id) {
        $sql = self::$connection->prepare("SELECT * FROM `products`,protypes,manufactures WHERE products.type_ID = protypes.type_ID && manufactures.manu_ID = products.manu_ID && products.ID= $id");   
        return $this->select($sql);
    }
