...
$type = $protype->getProtypeByID($_GET["ID"]);
...
if(isset($_POST['add'])){
	...
	if(!($_FILES['fileUpload']['name'] == ""))
	{
		...
		$image = $type[0]["type_img"];
	}
	$protype->capNhat($name, $image ,$_GET['ID']);
					...
					<div class="widget-content nopadding">
						...
						<form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span11" value="<?php echo $type[0]["type_name"] ?>" name="type_name" /> *
								</div>
							</div>
							<div class="control-group">
