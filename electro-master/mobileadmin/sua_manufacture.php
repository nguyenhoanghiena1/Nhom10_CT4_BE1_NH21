...
$type = $manufactures->getManuByID($_GET["ID"]);
...
if(isset($_POST['add'])){
	...
	$manufactures->capNhat($name, $image ,$_GET['ID']);
					...
					<div class="widget-content nopadding">
						...
						<form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span11" value="<?php echo $type[0]["manu_name"] ?>" name="manu_name" /> *
								</div>
							</div>
